    ...
    Box(
        ...
        Row(
            ...
            Column(
                ...
                Text(text = number, style=MaterialTheme.typography.h4.copy(fontWeight=FontWeight.Bold))
                Text(text=title)
            }
            ...
            if (isEditing.value) {
                ...
                IconButton(onClick={ // 전화 앱을 시작합니다.
                    ...
                    if(permissionState.status.isGranted){
                        val intentUri=Uri.parse("tel:$number")
                        val callIntent=Intent(Intent.ACTION_CALL,intentUri)
